    ...
    if(!card) {
        display = (
            <div className="relative lg:w-6/12 w-full bg-zinc-900 lg:p-10 p-16 border rounded-2xl flex justify-center items-center border border-4 border-zinc-700 hover:border-zinc-500 transition-all duration-300">
                <svg onClick={() => useCard(!card)} xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth="1.5" stroke="currentColor" className="w-7 h-7 absolute right-2 top-2 stroke-zinc-400 cursor-pointer">
