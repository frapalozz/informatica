export default function Footer() {
    return(
        <>
            <section className="max-w-screen-2xl w-screen center px-3.5 md:px-4 lg:px-6 xl:px-8 flex flex-col items-center mb-6 mt-auto">
                ...
                <div className="flex flex-row justify-between items-center w-full xl:mt-10 lg:mt-8 md:mt-6 mt-5">
                    <p className="dark:text-white text-black text-sm min-h-4">❤️‍🔥 da <a href="https://github.com/frapalozz" target="_blank" className="underline">Frapalozz</a></p>

                    <div className="flex flex-row justify-center items-center gap-5">
                        <a href="https://chat.whatsapp.com/DJNA2KG0PnS5XG6pfFQCZU" target="_blank">
                        ...
                        <a href="https://t.me/+5JM3ec-W3Sg3MDJk" target="_blank">
