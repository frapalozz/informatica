...
export default function Navbar() {
    return(
        <>
            <header className="dark:bg-stone-950/40 bg-stone-100/40 backdrop-blur-md max-w-screen-2xl w-screen center px-3.5 md:px-4 lg:px-6 xl:px-8 flex flex-col items-center fixed z-50 top-0 mb-9">
                ...
                <nav className="flex flex-row justify-between items-center w-full h-full xl:mt-9 lg:mt-7 md:mt-5 mt-4">
                    ...
                    <div>
                        <a href="https://forms.gle/tGFM4bSCNoKdDKJi6" className="dark:bg-white bg-black text-white dark:text-black xl:px-5 lg:px-4 md:px-3.5 px-3 xl:py-3.5 lg:py-3 py-2 rounded-lg xl:text-lg font-bold hover:shadow-lg dark:hover:shadow-zinc-700 hover:shadow-zinc-300 duration-300 transition-all">Aggiungi risorsa +</a>
                    </div>
                </nav>
