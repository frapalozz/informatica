    ...
    return(
        <section className="max-w-screen-2xl w-full center px-3.5 md:px-4 lg:px-6 xl:px-8 flex flex-col items-center mt-2">
            ...
            <div className="flex flex-col items-center justify-center font-medium text-sm">
                ...
                <input onChange={(e) => {setMateria(e.target.value)}} className="dark:bg-zinc-950 bg-white dark:border-zinc-700 focus:dark:border-zinc-500 border-zinc-400 dark:text-white text-black border-2 rounded px-2 outline-none font-semibold text-base" type="text" />
            </div>
