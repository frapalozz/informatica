...
export default function DonationButton() {
    ...
    return (
        <>
            <div id='btn-container' className={`${vt323.className} fixed -bottom-14 right-auto left-auto flex flex-col-reverse transition-all duration-500 ease-in-out`}>
                
                <div id='btn' onClick={handleClick} className='dark:text-white text-black select-none dark:bg-zinc-700/5 bg-zinc-200/50 border-2 dark:border-zinc-700 border-zinc-400 hover:border-zinc-300 backdrop-blur px-5 py-3 rounded-md cursor-pointer transition-all duration-300'>
                    Prendi una Monetina
                </div>
