    ...
    return(
        <>
            <section className="max-w-screen-2xl w-full center px-3.5 md:px-4 lg:px-6 xl:px-8 flex flex-col items-center xl:mt-55 lg:mt-48 md:mt-40 mt-36 relative z-[60]">
                ...
                <div className="grid grid-cols-4 max-h-14 justify-center items-center text-white border-solid rounded-md dark:border-zinc-700 border-zinc-400 border mt-6 dark:bg-stone-950/5 bg-stone-100/5 backdrop-blur-sm">
