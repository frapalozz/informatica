...
export default function MateriaCard({ extraLink, extraName, extra, immagine, anno}: any){
    ...
    if(!card) {
        return (
            <div className="relative lg:w-6/12 w-full dark:bg-zinc-900/20 bg-zinc-200/20 backdrop-blur-sm lg:p-10 p-16 rounded-2xl flex justify-center items-center border-4 dark:border-zinc-700 border-zinc-400 dark:hover:border-zinc-500 hover:border-zinc-500 transition-all duration-300 relative z-[60]">
